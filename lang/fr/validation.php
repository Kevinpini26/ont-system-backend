...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | L'application étant destinée à des agents francophones (ONT/RDC), ces
    | messages remplacent les clés anglaises par défaut de Laravel — sans
    | cette traduction, les erreurs de formulaire affichent la clé brute
    | (ex. "validation.required") au lieu d'un message compréhensible.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute a été trouvé dans une fuite de données connue. Merci d\'en choisir un autre.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'date_debut_stage' => 'date de début de stage',
        'date_fin_stage' => 'date de fin de stage',
        'candidat_nom' => 'nom du candidat',
        'candidat_contact' => 'contact du candidat',
        'candidat_etablissement' => 'établissement du candidat',
    ],
